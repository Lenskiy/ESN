...
lID(4) = net.addLayer(50, 'reservoir', struct('nodeType', 'tanh', 'radius', 1.0, 'leakage', 1.0, 'connectivity',0.1, 'initType', 'randn'));
...
arch = sparse([lID(1) lID(2) lID(1) lID(1) lID(1) lID(5) lID(4) lID(4) lID(5) lID(6)],...
              [lID(6) lID(4) lID(3) lID(4) lID(5) lID(3) lID(3) lID(5) lID(6) lID(3)], connections,6,6);
